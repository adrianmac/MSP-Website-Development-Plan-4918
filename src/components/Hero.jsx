    ...
    <section id="home" className="relative bg-gradient-to-br from-blue-800 to-primary text-white py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            Specialized technology solutions including PCI compliance, restaurant wiring, audio systems, and networking services. Secure, reliable IT support tailored for small businesses and the food service industry.
          </motion.p>
